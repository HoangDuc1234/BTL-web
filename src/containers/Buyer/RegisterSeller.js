...
class RegisterSeller extends Component {
  ...
  handleSubmit = async (event) => {
    ...
    try {
      ...
      if (res && res.success) {
        toast.success(
          "Đăng ký thành công! Chúng tôi sẽ xem xét và phản hồi trong vòng 24 giờ.",
          {
            position: "top-right",
            autoClose: 3000,
            ...
            <div className="shop-status-container">
              {shopStatus === "pending" && (
                <div className="status-pending">
                  ...
                  <p>
                    Yêu cầu đăng ký shop của bạn đang được xem xét. Chúng tôi sẽ
                    thông báo cho bạn khi có kết quả.
                  </p>
                </div>
              )}
              ...
              {shopStatus === "accepted" && (
                <div className="status-accepted">
                  ...
                  <p>
                    Chúc mừng! Shop của bạn đã được duyệt. Bạn có thể bắt đầu
                    quản lý shop của mình ngay bây giờ.
                  </p>
                  <button
                    className="btn-manage-shop"
                    onClick={() =>
                      this.props.history.push("/seller/shop-manage")
                    }
                  >
                    Quản lý shop
                  </button>
              ...
              <div className="form-row">
                <div className="form-group col-6">
                  ...
                  <input
                    ...
                    value={shopName}
                    onChange={(event) =>
                      this.handleOnChangeInput(event, "shopName")
                    }
