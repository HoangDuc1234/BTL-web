      ...
      <footer className="footer-container">
        <div className="footer-content">
          <div className="footer-section about">
            ...
            <p>
              Nền tảng mua sắm trực tuyến hàng đầu Việt Nam, cung cấp đa dạng
              sản phẩm với chất lượng đảm bảo và dịch vụ khách hàng tuyệt vời.
            </p>
            <div className="contact">
              ...
              <span>
                <i className="fas fa-envelope"></i> &nbsp; info@googleclone.com
              </span>
            </div>
