...
class ShopAdmin extends Component {
  ...
  handleConfirmRejectShop = async () => {
    ...
    try {
      ...
      let res = await this.props.rejectShop(
        shopToReject.shop_id,
        rejectionReason
      );
      ...
      <div className="users-container">
        {isLoading ? (
          ...
          <div>
            <div className="title">
              <FormattedMessage
                id="manage-shop.title"
                defaultMessage="Quản lý Shop"
              />
            </div>
                        ...
                        <td>
                          <div
                            ...
                            style={{
                              ...
                              backgroundImage: `url(${
                                item.img
                                  ? CommonUtils.getBase64Image(item.img)
                ...
                <div className="modal-content">
                  <div className="modal-header">
                    <h3 className="modal-title">
                      <i className="fas fa-exclamation-triangle"></i> Xác nhận
                      xóa
                    </h3>
                    <button
                      type="button"
            ...
            {isShowRejectModal && (
              <div className="confirm-modal">
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <p>
                      Bạn đang từ chối shop{" "}
                      <strong>{shopToReject.shop_name}</strong>
                    </p>
                  ...
                  <div className="modal-footer">
                    ...
                    <button
                      className="btn btn-danger"
                      onClick={this.handleConfirmRejectShop}
                    >
